...
<body>
	...
	<div style="text-align: center">
		<input type="text" type="text" class="form-control" id="datepick"
			value="${date}" onchange=""> <select class="form-control"
			name="menu1" id="menu1">
		...
		<div class="row">
			<c:forEach var="picture" items="${pictures}">
				...
				<a
					href="img/${picture.path}"
					data-toggle="lightbox" data-gallery="multiimages"
					data-title="${cam.name}" class="col-sm-2"><img
					src="img/${picture.getPathSmall()}"
